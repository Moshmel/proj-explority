...
<div class="wrapper"> 
  <div class="activity flex">
      ...
      <div class="info">
        ...
        <div class="flex space-between de"><h1 class="title">{{activity.title}}</h1>
        <button class="book-btn" type="button">Book now!</button>
        </div>
        <img src="https://img.icons8.com/ios-glyphs/24/000000/marker.png" style="margin-left: -6px;">
        <span>{{activity.address}}</span>
         <star-rating  class="star" v-model="activity.rating" round-start-rating="true" :star-size="20"></star-rating>
        <p>rated : {{activity.ratingCount}} times</p>
   <div class="about">
        <h1>About Exprience</h1>
        <p>The session is for those who have an interest in becoming a barista, or for people to develop an existing coffee skill set. 
...
We will also cover some fundamental info on the daily care and maintenance of your equipment.</p>
             <p>voluptate, dignissimos deleniti totam quasi provident explicabo
             quaerat nesciunt numquam nisi!s</p>
 ...
 <star-rating   v-model="activity.rating" round-start-rating="true" :star-size="20"></star-rating>
          ...
          <p>
            This tour was amazing. I had a great time even though it was raining during our tour. Mayno is such a sweet lady... she gave me a gift, she’s very polite and she really made sure that I would enjoy the whole kawaii experience in Harajuku.
          </p>
        ...
        <div class="user-details flex">
          ...
          <p>
           My  wife and I wanted to experience the Kawaii culture and Mayno did such a great job showing us around. She was so nice - It was pouring rain and she moved the time around so we would be able to enjoy the tour without the rain.
          </p>
        ...
        <div class="user-details flex">
          ...
          <p>
           sweet lady... she gave me a gift, she’s very polite and she really made sure that I would enjoy the whole kawaii experience in Harajuku. We went to different cute stores... all of them were unique. 
          </p>
    ...
    <!-- <form class="review-section">
      ...
      <ul class="review-list">
        <div v-for="review in this.activity.reviews" :key="review._id">
        <span>{{review.user.username}} wrote on {{ review.createdTime | moment("from", "now")}}</span>
