<template>
  <div class="activity-preview" @click="viewDetails(activity)">
    
    <img class="main-img" :src="activity.imgs[0]" @load="loaded" alt="">
    <div class="bottom-container flex column space-between">
    ...
    <div class="space-between flex bottom-btn">
      <button @click="book(activity)" class="book-btn" v-if="activity.price || activity.type ==='lodging'">Book</button>
